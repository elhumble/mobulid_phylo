#~~ Script to plot PCAs mobulid clades for Dataset A
...
mantas_data <- prep_genlight(plink_raw = "data/p10_mantas.raw",
                             meta = "data/IDs_p10_mantas.txt")

mobjap_data <- prep_genlight(plink_raw = "data/p10_mobjap.raw",
                             meta = "data/IDs_p10_mobjap.txt")

thurerekuh_data <- prep_genlight(plink_raw = "data/p10_thurerekuh.raw",
                             meta = "data/IDs_p10_thurerekuh.txt")

hypmunk_data <- prep_genlight(plink_raw = "data/p10_hypmunk.raw",
...
png(file="figs/Figure_3.png", units = "in", res = 300, height=11, width=7)
...
png(file="figs/Full_PCA_Dataset_A.png", units = "in", res = 300, height=5, width=13)
x + y
dev.off()
...
png(file="figs/Figure_S3.png", units = "in", res = 300, height=10, width=9)
eig_plot_a + eig_plot_b
dev.off()
